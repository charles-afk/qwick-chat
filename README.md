...
<p style='font-size:20px;'>Enables image upload and storage using AWS S3, supporting both user profile pictures andchat-related media, ensuring scalable and secure handling of multimedia content.</p>
<img src='images/chat.png' width='100%'/>
<p style='font-size:20px;'>A real time chat interface built using websockets for both live chatting and online status updates from your friends list.</p>
<img src='images/theme.png' width='100%'/>
<p style='font-size:20px;'>Dynamic themes for user preference.</p>